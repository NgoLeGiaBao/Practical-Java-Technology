...
public class Ex5Application {
	...
	@Autowired
	private StudentRepository studentRepository; // Tiêm StudentRepository
	...
	public CommandLineRunner commandLineRunner() {
		return args -> {
			...
			List<Student> studentsAbove21 = studentRepository.findByAge(21);
			System.out.println("Danh sách sinh viên từ 21 tuổi trở lên:");
			studentsAbove21.forEach(student -> System.out.println(student));

			long countIelts7 = studentRepository.countByIelts(7.0);
			System.out.println("Số sinh viên có điểm IELTS bằng 7.0: " + countIelts7);

			List<Student> studentsWithNameContainingNguyen = studentRepository.findByName("Nguyen");
